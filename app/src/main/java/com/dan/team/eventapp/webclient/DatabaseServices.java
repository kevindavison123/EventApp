...
public class DatabaseServices extends Service
{
    ...
    public void addEvent(Event event)
    {
        ...
        params.put("event_gps_desc", event.getCoords().getDescription());
        params.put("event_gps_coord1", name);
        params.put("event_gps_coord2", name);
            ...
            public void onJSONResponse(boolean success, Context context, JSONObject response)
            {
                ...
                try
                {
                    Event event = new Event(
                            response.getInt(context.getString(R.string.Event_ID)),
                            ...
                            new GPSCoords(response.getInt(context.getString(R.string.Event_GPS_ID)),
                                    response.getString(context.getString(R.string.Event_GPS_Description)),
                                    new double[]{Double.parseDouble(response.getString(context.getString(R.string.Event_GPS_Coord1))),
                                            Double.parseDouble(response.getString(context.getString(R.string.Event_GPS_Coord2)))}));
    ...
    public void updateEvent(int eid, Event newEvent)
    {
        ...
        params.put("event_name", name);
        params.put("event_gps_desc", newEvent.getCoords().getDescription());
        params.put("event_gps_coord1", name);
        params.put("event_gps_coord2", name);
